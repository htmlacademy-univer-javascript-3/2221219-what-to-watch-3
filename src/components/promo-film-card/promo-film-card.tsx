...
export default function PromoFilmCard({FilmImgSrc, FilmTitle, FilmGenre, FilmYear}: PromoFilmCardProps): ReactNode {
  return (
    <div className="film-card__wrap">
      <div className="film-card__info">
        <div className="film-card__poster">
          <img src={FilmImgSrc} alt={FilmTitle} width="218" height="327" />
        </div>
